<template>
    ...
    <main data-scroll-container class="main">
                      ...
                      <nav class="nav-bar">
                          ...
                          <div class="page-header-links">
                              <ul>
                                  ...
                                  <li class="menu-links-items"><a data-scroll-to class="menu-links-items-a" href="https://drive.google.com/file/d/1r1-QHHA1hI-KpBRw9n-WggTuPnDygD7M/view?usp=sharing">my resume</a></li> 

                                  <div class="nav-mail-div">
                                        <p>Get in touch</p>
                                        <a id="nav-mail" href="mailto:amosbett99@gmail.com">amosbett99@gmail.com</a>
                                   </div>
                                    <div class="social-links-container">
                                        <div class="social-links-a-div">
                                            <a id="linkedinSocialLink" class="social-links-icons" target="_blank" href="https://www.linkedin.com/in/amosbett99"><i class="fa-brands fa-linkedin"></i></a>
                                            <a id="githubSocialLink" class="social-links-icons" target="_blank" href="https://github.com/lixelamos"><i class="fa-brands fa-github"></i></a>
                                            <a id="behanceSocialLink" class="social-links-icons" target="_blank" href="https://www.behance.net/amosbett"><i class="fa-brands fa-behance"></i></a>
                                             <a id="instagramSocialLinks" class="social-links-icons" target="_blank" href="https://www.instagram.com/amos_lixel/"><i class="fa-brands fa-instagram"></i></a>
                                        </div>
                                    </div>
                                </ul>
                          </div>
      ...
      <div class="social-links">
          <div class="social-links-container">
              <a id="linkedinSocialLink" class="social-links-icons" target="_blank" href="https://www.linkedin.com/in/amosbett99/">
            ...
            <a id="githubSocialLink" class="social-links-icons" target="_blank" href="https://github.com/lixelamos">
                  <svg xmlns="http://www.w3.org/2000/svg" role="img" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-github"><title>GitHub</title><path d="M9 19c-5 1.5-5-2.5-7-3m14 6v-3.87a3.37 3.37 0 0 0-.94-2.61c3.14-.35 6.44-1.54 6.44-7A5.44 5.44 0 0 0 20 4.77 5.07 5.07 0 0 0 19.91 1S18.73.65 16 2.48a13.38 13.38 0 0 0-7 0C6.27.65 5.09 1 5.09 1A5.07 5.07 0 0 0 5 4.77a5.44 5.44 0 0 0-1.5 3.78c0 5.42 3.3 6.61 6.44 7A3.37 3.37 0 0 0 9 18.13V22"></path>
                  </svg>      
              </a>
              <a id="instagramSocialLink" class="social-links-icons" target="_blank" href="https://www.instagram.com/amos_lixel/">
              ...
              <a id="behanceSocialLink" class="social-links-icons" target="_blank" href="https://www.behance.net/amosbett">
